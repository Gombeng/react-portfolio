export const data = {
  ...
  works: [
    ...
    {
      img: require("./images/project-porto.png"),
    ...
    {
      img: require("./images/project-restapi.png"),
    ...
    {
      img: require("./images/project-denote.png"),
      title: "Denote",
    ...
    {
      img: require("./images/project-kitteni.png"),
      title: "Kitteni",
    ...
    {
      img: require("./images/project-quiz.png"),
      title: "Easely Quiz",
